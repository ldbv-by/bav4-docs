...
# BayernAtlas WebComponent

Embed interactive maps in your web applications.
...
```html
// Simple map <bayern-atlas></bayern-atlas>
```
...
```html
// Drawing tools <bayern-atlas ec_draw_tool="polygon"></bayern-atlas>
```
